...
export const metadata: Metadata = {
  title: 'Download Ethiopian Grade  9 Chemistry Textbook PDF | Exam Galaxy ',//Download Ethiopian Grade  9 Biology Textbook PDF | Exam Galaxy
  ...
  openGraph: {
    title: 'Download Ethiopian Grade  9 Chemistry Textbook PDF | Exam Galaxy ',
